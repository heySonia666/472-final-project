...
As the answering party of the question has a clear affiliation with the organization, it can “back infer” the information of the asking party from the economic, health and welfare related organizations. The institution name can be seen below in the code. 
...
Observing the question-percentage in specific gender rather than gender-specific percentages in different questions is because that male and female MPs do not have the same number of people, as the data from House of Common Library shows that women make up 31% of parliamentarians (2022).
